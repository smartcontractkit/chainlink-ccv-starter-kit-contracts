...
- **Contracts** — factory / resolver / verifier per chain, linked to an explorer
- **Deploy-time inputs** — `rmn` and `versionTag` (CommitteeVerifier constructor
  arguments, immutable after deployment) and `resolverSalt` (the CREATE2 salt that fixes
