...
```bash
# requires: CHAIN, TARGET, RPC_URL, OUTPUT_MODE=SAFE, SAFE_ADDRESS
make transfer-owner CHAIN=sepolia TARGET=verifier:0x00010001 RPC_URL=$SEPOLIA_RPC_URL \
  OUTPUT_MODE=SAFE SAFE_ADDRESS=0x<the executing Safe>
